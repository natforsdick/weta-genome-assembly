...
OUTDIR=/nesi/nobackup/ga03048/weta/assemblies/hifiasm/04-alignment/
...
if [ ! -e ${REFDIR}${REF}.mmi ]; then
	...
	minimap2 -t 24 -d ${REFDIR}${REF}.mmi ${REFDIR}${REF}.fna
fi
echo "Aligning $QUERY to $REF"
minimap2 -ax asm5 -t 18 ${REFDIR}${REF}.mmi ${INDIR}${QUERY}.fa > GCA_946902985.2-curated-AG1149-mapped.PT-yahs_scaffolds.paf
