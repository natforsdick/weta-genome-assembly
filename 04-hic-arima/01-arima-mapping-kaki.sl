...
#SBATCH --job-name=arima_map_weta # job name (shows up in the queue)
#SBATCH --cpus-per-task=52 # mapping can use 18, subsequent processing requires 6
#SBATCH --mem=86G
#SBATCH --time=12:00:00 #Walltime (HH:MM:SS) # Total processing minimum 12 hrs
